...
[![x-cmd/install — tatuin Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/tatuin.svg?lang=zh)](https://x-cmd.com/install/tatuin)
...
合计: **18,698** 行代码（覆盖前 5 种语言、共 **109** 个文件）。
...
- **上游仓库**: <https://github.com/panter-dsd/tatuin>
- **许可证**: MIT

## 发布

- **最新版本**: `v0.27.0` (2026-09-16)
- **最近提交**: 2026-09-21
- **Release 含资产**: 26 个

## 流行度

- **Star**: 142 · **Fork**: 4 · **开放 issue**: 124 · **贡献者**: 4

## 累计统计

- **发布数**: 44 · **已合并 PR**: 347 · **开放 PR**: 0 · **已关闭 issue**: 106 · **开放 issue**: 18 · **提交数**: 1655

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-24 | 1 | 14 | 0 | 1 | 0 | 22 |
| last60d | 2026-07-25 | 1 | 26 | 0 | 1 | 0 | 34 |
| 90d | 2026-06-25 | 1 | 40 | 0 | 1 | 0 | 47 |
| last180d | 2026-03-27 | 1 | 75 | 0 | 2 | 0 | 106 |
| 360d | 2025-09-28 | 7 | 193 | 0 | 38 | 4 | 406 |
| last720d | 2024-10-03 | 44 | 347 | 0 | 106 | 18 | 1655 |
...
tatuin 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `tatuin` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/tatuin.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T05:37:47Z._
