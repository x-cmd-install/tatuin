...
![tatuin](https://repo.x-cmd.io/tatuin.svg?lang=zh)
...
合计: **18,713** 行代码（覆盖前 5 种语言、共 **109** 个文件）。
...
- **最新版本**: `v0.26.0` (2026-01-16)
- **最近提交**: 2026-09-07
- **Release 含资产**: 26 个

## 流行度

- **Star**: 138 · **Fork**: 4 · **开放 issue**: 123 · **贡献者**: 4

## 累计统计

- **发布数**: 43 · **已合并 PR**: 340 · **开放 PR**: 0 · **已关闭 issue**: 105 · **开放 issue**: 18 · **提交数**: 1633
...
在 [repology.org](https://repology.org/project/tatuin) 上共有 **4** 个发行版报告此项目。**3** 个 ✅ 已是最新上游版本，**1** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260910.yml` · 2026-09-10T20:46:33Z._
